...
SORT_BY = 'score' # 可选值: 'updated', 'score', 'id'(default)
...
DATA_OUTPUT_PATH = r'D:\pyworks\BooruCrawler\output\datasets'

DOWNLOAD_IMAGES = False

IMAGES_OUTPUT_PATH = r'D:\pyworks\BooruCrawler\output\images'
